...
function Dresses() {
  ...
  useEffect(() => {
    const imports = import.meta.glob('/content/dresses/*.md', { as: 'raw' });
  ...
  return (
    <div className="p-6 bg-white min-h-screen text-center">
      ...
      <h1 className="text-3xl font-bold mb-6">Dress Materials</h1>
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {dresses.map((item, index) => (
          ...
          >
            ...
            {item.isAvailable ? (
              <a
                href={`https://wa.me/91xxxxxxxxxx?text=I'm%20interested%20in%20${encodeURIComponent(
                  item.title
                )}`}
                target="_blank"
                rel="noreferrer"
